...
using Skoruba.IdentityServer4.Admin.Api.Controllers;
using AutoMapper;
...
namespace Skoruba.IdentityServer4.Admin.UnitTests.Controllers
{
    ...
    {
        private ICustomIdentityService<PersonDto<long, UserDto<string>, string>, long, Person, UserDto<string>, string, long,
               PepoleDto<PersonDto<long, UserDto<string>, string>, long, UserDto<string>, string>> GetIdentityService(IServiceProvider services)
        {
            try
            {
                return services.GetRequiredService<ICustomIdentityService<PersonDto<long, UserDto<string>, string>, long, Person, UserDto<string>, string, long,
                   PepoleDto<PersonDto<long, UserDto<string>, string>, long, UserDto<string>, string>>>();
            }
            catch(Exception ex)
            {
                return null;
        ...
        private PersonController<PersonDto<long, UserDto<string>, string>, long, Person, UserDto<string>, string, long,
               PepoleDto<PersonDto<long, UserDto<string>, string>, long, UserDto<string>, string>> PrepareIdentityController(IServiceProvider serviceProvider)
        {
            // Arrange
            ...
            //Get Controller
            var controller = new PersonController<PersonDto<long, UserDto<string>, string>, long, Person, UserDto<string>, string, long,
               PepoleDto<PersonDto<long, UserDto<string>, string>, long, UserDto<string>, string>>(identityService, CustomMapper);
        ...
        private IServiceProvider GetServices()
        {
            ...
            services.AddOptions();
            services.AddDbContext<CustomDbContext>(b => b.UseInMemoryDatabase(Guid.NewGuid().ToString()).UseInternalServiceProvider(efServiceProvider));
            ...
            services.AddCustomIdentityServices<CustomDbContext, Person, UserIdentity, PersonDto<long, UserDto<string>, string>, long, UserDto<string>, string, PepoleDto<PersonDto<long, UserDto<string>, string>, long, UserDto<string>, string>, long, string>(null);
